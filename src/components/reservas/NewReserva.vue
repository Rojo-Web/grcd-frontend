  ...
  <div class="container">
    ...
    <form @submit.prevent="saveReserva">
      ...
      <div class="row justify-content-center align-items-center">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input
                ...
                v-model="reserva.fecha_hora_inicio"
              />
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="mb-3">
            <label for="fecha_hora_final" class="form-label"
            ...
            <div class="input-group">
              ...
              <input
                ...
                v-model="reserva.fecha_hora_final"
              />
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async saveReserva() {
      console.log(
        `${this.reserva.id} ${this.reserva.number} ${this.reserva.date} ${this.reserva.customer_id} ${this.reserva.pay_mode_id}`
      );
