        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="alert alert-success" role="alert">
                    <h1 class="mb-0" style="color: green;">Clases</h1>
                </div>
                <button @click="newClase()" class="btn btn-succes mx-2">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="(clase, index) in clases" :key="index">
                            ...
                            <td>
                                <button @click="deleteClase(clase.id)" class="btn btn-succes mx-2">
                                    <font-awesome-icon icon="trash" />
                                </button>
                                <button @click="editClase(clase.id)" class="btn btn-succes mx-2">
